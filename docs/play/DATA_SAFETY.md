...
- PocketForge does not operate a first-party account system in the current release.
...
The app itself does not send projects or conversations to the PocketForge developer unless a user deliberately shares them through a separate support channel.
