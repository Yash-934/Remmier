...
PocketForge uses two user-initiated `specialUse` foreground services. The manifest subtype descriptions and Play Console declaration must match the behavior below.
...
1. Open PocketForge and start runtime setup from the explicit Install button.
