...
This checklist covers the Play-facing work for package `com.pocketforge.mobile`. It does not resolve the separate policy and technical review required for the downloadable local Linux and Claude Code runtime.

## Implemented in the project

- [x] Stable application ID: `com.pocketforge.mobile`
...
- [ ] Reserve and register `com.pocketforge.mobile` in Play Console
...
Account-deletion and Play Billing requirements apply only if PocketForge later introduces first-party accounts or sells digital subscriptions in the app.
