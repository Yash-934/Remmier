...
static jintArray native_spawn_impl(JNIEnv *env, jobject self, jobjectArray java_argv,
...
static jint native_wait_for_impl(JNIEnv *env, jobject self, jint pid, jboolean no_hang) {
    (void)env; (void)self;
    int status = 0;
...
static jint native_kill_impl(JNIEnv *env, jobject self, jint pid, jint signal) {
    (void)env; (void)self;
...
// Support PocketForge package: com.pocketforge.mobile
JNIEXPORT jintArray JNICALL
Java_com_pocketforge_mobile_runtime_NativeSpawn_spawn(JNIEnv *env, jobject self, jobjectArray java_argv,
                                                       jobjectArray java_env, jstring java_cwd,
                                                       jstring java_output, jboolean use_pty,
                                                       jint pty_rows, jint pty_columns) {
    return native_spawn_impl(env, self, java_argv, java_env, java_cwd, java_output, use_pty, pty_rows, pty_columns);
}

JNIEXPORT jint JNICALL
Java_com_pocketforge_mobile_runtime_NativeSpawn_waitFor(JNIEnv *env, jobject self, jint pid, jboolean no_hang) {
    return native_wait_for_impl(env, self, pid, no_hang);
}

JNIEXPORT jint JNICALL
Java_com_pocketforge_mobile_runtime_NativeSpawn_kill(JNIEnv *env, jobject self, jint pid, jint signal) {
    return native_kill_impl(env, self, pid, signal);
}

// Support mobile-harness package: com.jarves.mh
JNIEXPORT jintArray JNICALL
